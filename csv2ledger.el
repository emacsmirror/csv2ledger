...
;; Copyright (c) 2023 Joost Kremers
;; All rights reserved.
...
;;
;; Normally, a ledger entry has the payee in top line of an entry, but if you
;; receive money, your CSV file likely lists you as the payee.  To use the
;; sender instead in such cases, set the variable `c2l-account-holder' to a
;; regular expression matching your name (i.e., whatever appears as the payee in
;; your CSV file when you receive money).
;;
